...
/*float my_multiple(float a , float b){

    return a * b;
}*/

int my_multiple(int c , int d){

    return c * d;
}

//THM : "number" - type function can eat any number type parameter but will transform the parameters and the return value
//into the function type. When function overload is is used take care, declare and define the function not just call
//

int main() {

    cout << my_multiple(1.25f , 2.33f) << endl;

    cout << my_multiple(1 , 2) << endl;
